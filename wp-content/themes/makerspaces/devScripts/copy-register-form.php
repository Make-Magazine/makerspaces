...
foreach ($mspaces as $row) {
            ...
            switch ($field_number) {
               ...
               case '12':
                  ...
                  switch (strtolower($meta_value)) {
                     case "alabama":         $insert_array[] = array('12', 'AL');   break;
                     case "arizona":         $insert_array[] = array('12', 'AZ');   break;
                     case "arkansas":        $insert_array[] = array('12', 'AR');   break;
                     case 'california':      $insert_array[] = array('12', 'CA');   break;
                     case 'colorado':        $insert_array[] = array('12', 'CO');   break;
                     case 'connecticut':     $insert_array[] = array('12', 'CT');   break;
                     case 'delaware':        $insert_array[] = array('12', 'DE');   break;
                     case 'florida':         $insert_array[] = array('12', 'FL');   break;
                     case 'georgia':         $insert_array[] = array('12', 'GA');   break;
                     case 'idaho':           $insert_array[] = array('12', 'ID');   break;
                     case 'illinois':        $insert_array[] = array('12', 'IL');   break;
                     case 'indiana':         $insert_array[] = array('12', 'IN');   break;
                     case 'iowa':            $insert_array[] = array('12', 'IA');   break;
                     case 'kansas':          $insert_array[] = array('12', 'KS');   break;
                     case 'kentucky':        $insert_array[] = array('12', 'KY');   break;
                     case 'louisiana':       $insert_array[] = array('12', 'LA');   break;
                     case 'maine':           $insert_array[] = array('12', 'ME');   break;
                     case 'maryland':        $insert_array[] = array('12', 'MD');   break;
                     case 'massachusetts':   $insert_array[] = array('12', 'MA');   break;
                     case 'michigan':        $insert_array[] = array('12', 'MI');   break;
                     case 'minnesota':       $insert_array[] = array('12', 'MN');   break;
                     case 'mississippi':     $insert_array[] = array('12', 'MS');   break;
                     case 'missouri':        $insert_array[] = array('12', 'MO');   break;
                     case 'montana':         $insert_array[] = array('12', 'MT');   break;
                     case 'nebraska':        $insert_array[] = array('12', 'NE');   break;
                     case 'nevada':          $insert_array[] = array('12', 'NV');   break;
                     case 'new hampshire':   $insert_array[] = array('12', 'NH');   break;
                     case 'new jersey':      $insert_array[] = array('12', 'NJ');   break;
                     case 'new mexico':      $insert_array[] = array('12', 'NM');   break;
                     case 'new york':        $insert_array[] = array('12', 'NY');   break;
                     case 'north carolina':  $insert_array[] = array('12', 'NC');   break;
                     case 'north dakota':    $insert_array[] = array('12', 'ND');   break;
                     case 'ohio':            $insert_array[] = array('12', 'OH');   break;
                     case 'oklahoma':        $insert_array[] = array('12', 'OK');   break;
                     case 'oregon':          $insert_array[] = array('12', 'OR');   break;
                     case 'pennsylvania':    $insert_array[] = array('12', 'PA');   break;
                     case 'rhode island':    $insert_array[] = array('12', 'RI');   break;
                     case 'south carolina':  $insert_array[] = array('12', 'SC');   break;
                     case 'south dakota':    $insert_array[] = array('12', 'SD');   break;
                     case 'tennessee':       $insert_array[] = array('12', 'TN');   break;
                     case 'texas':           $insert_array[] = array('12', 'TX');   break;
                     case 'utah':            $insert_array[] = array('12', 'UT');   break;
                     case 'vermont':         $insert_array[] = array('12', 'VT');   break;
                     case 'virginia':        $insert_array[] = array('12', 'VA');   break;
                     case 'washington':      $insert_array[] = array('12', 'WA');   break;
                     case 'west virginia':   $insert_array[] = array('12', 'WV');   break;
                     case 'wisconsin':       $insert_array[] = array('12', 'WI');   break;
                     case 'wyoming':         $insert_array[] = array('12', 'WY');   break;
                     default:                $insert_array[] = array('12', $meta_value); //96.3 : Community Center
                  }
                  break;
               ...
               case '14':
                  ...
                  break;
               case '15.9':
                  if ($meta_value == 'Sunday')
                     $insert_array[] = array('15.9', 'Saturday');
                  break;
               case '60':
                  switch ($meta_value) {
                     case 'K12 School':
   ...
   echo 'copied ' . $orig_entry_id . ' from form 2 to ' . $entry_id . ' in form 5<Br/>';
   $meta = $wpdb->get_results($meta_sql);
   $count++;
}
